...
export function App() {
  ...
  return (
    <div className="flex flex-col bg-gradient-to-t from-slate-500 via-slate-300 to-slate-300 min-h-screen bg-no-repeat">
      <Header />
      ...
      <div className="max-w-xl flex mx-auto w-full flex-col gap-4 px-4 -translate-y-6">
        ...
        <div className="flex flex-col gap-4">
          {isLoading ? (
            <CircleNotch className="text-slate-500 animate-spin self-center" size={48} />
          ) : (
            transactions &&
